...
export default function ProductScreen() {
    ...
    return (
        <>
            ...
            <div class="richtext" contentEditable="true" onInput={handleChange}></div>
            {description && (
                <div class="description-preview description-preview--full">
                    <div class="pdp__description__heading">PRODUCT OVERVIEW</div>
                    <div class="pdp__description__left" dangerouslySetInnerHTML={{__html: description}}></div>
                </div>
            )
            }
        </>
