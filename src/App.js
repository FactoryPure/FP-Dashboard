...
function App() {
  ...
  const initData = async () => {
    const result = {
      products: await fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/products").then(res => res.json()),
      collections: await fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/collections").then(res => res.json()),
    }
    const shipping_brands = await fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/shipping").then(res => res.json())
    const shipping_skus = await fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/shipping?table=skus").then(res => res.json())
  ...
  useEffect(() => {
    ...
    if (token) {
      fetch(`https://ec2-54-173-39-172.compute-1.amazonaws.com/users/verify?token=${token}`)
      .then(res => res.json())
      .then(res => {
        if (res.success) {
    ...
    fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/notifications?email=gjarman@factorypure.com").then(res => res.json()).then(res => setNotifications(res.notifications))
  ...
  const checkForNotifications = (notifications) => {
    ...
    getNotifications = setInterval(() => {
      fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/notifications?email=gjarman@factorypure.com").then(res => res.json()).then(res => {
  ...
  const handleLogin = async (e) => {
    e.preventDefault()
    const response = await fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/users/login", {
      method: "POST",
      headers: {
  ...
  const handleCreate = async (e) => {
    ...
    const response = await fetch("https://ec2-54-173-39-172.compute-1.amazonaws.com/users/create", {
      method: "POST",
      headers: {
        'Content-Type': 'application/json'
      },
